...
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM, STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA) VALUES(1, 1, 0, 'ABERTA','NAO_PAGO',100.00,'2024121','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(2, 3, 0, 'ABERTA','NAO_PAGO',290,'2024122','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(3, 2, 0, 'ABERTA','NAO_PAGO',1991,'2024123','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(4, 4, 0, 'ABERTA','NAO_PAGO',221,'2024124','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(9, 1, 0, 'ABERTA','NAO_PAGO',1100,'2024125','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(4, 2, 0,'ABERTA','NAO_PAGO',224,'2024126','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(7, 3, 0,'ABERTA','NAO_PAGO',1822,'2024127','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(8, 4, 0, 'ABERTA','NAO_PAGO',900,'2024128','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(2, 1, 0, 'ABERTA','NAO_PAGO',70,'2024129','1234');
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR, ORDEM_LOGIN, ORDEM_SENHA)VALUES(5, 2, 0, 'ABERTA','NAO_PAGO',99,'20241210','1234');
