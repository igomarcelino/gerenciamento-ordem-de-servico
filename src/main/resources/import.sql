...
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM, STATUS_PAGAMENTO,VALOR) VALUES(1, 1, 0, 'ABERTA','NAO_PAGO',100.00);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(2, 3, 0, 'ABERTA','NAO_PAGO',290);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(3, 2, 0, 'ABERTA','NAO_PAGO',1991);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(4, 4, 0, 'ABERTA','NAO_PAGO',221);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(9, 1, 0, 'ABERTA','NAO_PAGO',1100);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(4, 2, 0,'ABERTA','NAO_PAGO',224);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(7, 3, 0,'ABERTA','NAO_PAGO',1822);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(8, 4, 0, 'ABERTA','NAO_PAGO',900);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(2, 1, 0, 'ABERTA','NAO_PAGO',70);
INSERT INTO ORDEM_SERVICO (CLIENTE_ID, FUNCIONARIO_ID, PAGAMENTO_ID, STATUS_ORDEM,STATUS_PAGAMENTO,VALOR)VALUES(5, 2, 0, 'ABERTA','NAO_PAGO',99);
